...
class AppRouter extends RootStackRouter {
  ...
  List<AutoRoute> get routes => [
        ...
        AutoRoute(path: RoutePaths.walletForm, page: WalletFormRoute.page),
        AutoRoute(path: RoutePaths.walletDetails, page: WalletDetailsRoute.page),
        AutoRoute(path: RoutePaths.transaction, page: TransactionRoute.page),
        ...
        AutoRoute(path: RoutePaths.subscriptions, page: SubscriptionsRoute.page),
